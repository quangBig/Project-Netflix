...
import { ORIGINAL_IMG_BASE_URL, SMALL_IMG_BASE_URL } from "../utils/constans.js";
...
const WatchPage = () => {
    ...
    const toggleFavorite = () => {
        if (isFavorite(id)) {
            removeFavorite(id, contentType); // Xóa khỏi danh sách yêu thích
        } else {
            addFavorite({
                itemId: id,
                type: contentType,
    ...
    if (!content) {
        return (
            <>
                <div className={`${theme === "dark" ? "bg-gray-900" : "bg-gray-400 text-black"}`}>
                    <Navbar />
                </div>
                <div className={`bg-black ${theme === "dark" ? "text-white" : "text-black"} h-screen`}>
                ...
                <div className='mx-auto container px-4 py-8 h-full'>
                    ...
                    <div className='flex flex-col md:flex-row items-center justify-between gap-20 max-w-6xl mx-auto'>
                        <div className='mb-4 md:mb-0'>
                            ...
                            >
                                {isFavorite(id) ? (
                                    <FaHeart className="text-red-500" /> // Đã thích
                                ) : (
                                    <FaRegHeart className="text-gray-500" /> // Chưa thích
                                )}
                            </button>
