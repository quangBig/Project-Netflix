        ...
        <div className='hero-bg relative'>
            ...
            <header className='max-w-6xl mx-auto flex items-center justify-between p-4 pb-10'>
                ...
                <div>
                    ...
                    {/* <button
                        onClick={toggleTheme}
                        className="ml-auto bg-blue-500 dark:bg-yellow-500 text-white px-4 py-2 rounded"
                    >
            ...
            <div className='py-10 bg-black text-white'>
              ...
              w-3/4 lg:w-1/2 h-24 border border-slate-500 rounded-md px-2 py-2
              '
                            >
                                <img src='/lol.png' alt='image' className='h-[80%]' />
            ...
            <div className='py-10 bg-black text-white'>
              ...
              '
                            ...
                            loop
                        >
                            <source src='/1225.mp4' type='video/mp4' />
                        </video>
                    </div>
                </div>
            </div>
