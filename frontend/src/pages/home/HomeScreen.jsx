...
import { MOVIE_CATEGORIES, ORIGINAL_IMG_BASE_URL, TV_CATEGORIES } from '../../utils/constans.js'
                ...
                <div className='absolute top-0 left-0 w-full h-full flex flex-col justify-center px-8 md:px-16 lg:px-32'>
                    ...
                    <div className='max-w-2xl'>
                        ...
                        <p className='mt-4 text-lg'>
                            {trendingContent?.overview.length > 1000
                                ? trendingContent?.overview.slice(0, 1000) + "..."
